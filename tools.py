...
def place_box_with_scrollbars(caller, frame, element, sb_h, sb_v, rw, d_n, d_e, d_s, d_w):
    ...
    element_width_in_pixel  = parent_width_in_pixel * (1 - d_w - d_e)
    element_height_in_pixel = parent_height_in_pixel * (1 - d_n - d_s)
    factor = parent_width_in_pixel / parent_height_in_pixel
    rel_size_sb_x = rw * element_width_in_pixel / parent_width_in_pixel
    rel_size_sb_y = rel_size_sb_x * factor # width relative to y
    element_width  = element_width_in_pixel / parent_width_in_pixel - rel_size_sb_x
    element_height = element_height_in_pixel / parent_height_in_pixel - rel_size_sb_y
