...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.cbdelrelpath_var = tk.IntVar()
        ...
        self.Listbox1.place(relx=0.035, rely=0.195, relheight=0.143
                , relwidth=0.187)
        ...
        self.Checkbutton1.place(relx=0.041, rely=0.043, relheight=0.028
                , relwidth=0.076)
        ...
        self.Button_save.place(relx=0.305, rely=0.684, height=24, width=67)
        self.Button_save.configure(activebackground="beige")
        ...
        self.Button_save_tooltip = \
        ToolTip(self.Button_save, '''Save''')

        self.Button_exec = tk.Button(self.top)
        self.Button_exec.place(relx=0.36, rely=0.684, height=24, width=57)
        ...
        self.Button_exec.configure(text='''Copy''')
        ...
        self.Button_delete = tk.Button(self.top)
        self.Button_delete.place(relx=0.409, rely=0.684, height=24, width=57)
        self.Button_delete.configure(activebackground="beige")
        self.Button_delete.configure(activeforeground="black")
        ...
        self.Button_delete_tooltip = \
        ToolTip(self.Button_delete, '''Delete from outdir''')

        self.Checkbutton_delrelpath = tk.Checkbutton(self.top)
        self.Checkbutton_delrelpath.place(relx=0.457, rely=0.684, relheight=0.027
                , relwidth=0.042)
        ...
        self.Checkbutton_delrelpath.configure(text='''Delete subdirs''')
        self.Checkbutton_delrelpath.configure(variable=self.cbdelrelpath_var)
        self.Checkbutton_delrelpath_tooltip = \
        ToolTip(self.Checkbutton_delrelpath, '''Delete subdirs created by copy''')
...
class Toplevel3:
    def __init__(self, top=None):
        ...
        self.Frame_camera_name.place(relx=0.042, rely=0.092, relheight=0.574
                , relwidth=0.297)
        self.Frame_camera_name.configure(relief='groove')
        self.Frame_camera_name.configure(borderwidth="2")
        self.Frame_camera_name.configure(relief="groove")
        ...
        self.Listbox_camera_name.place(relx=0.0, rely=0.0, relheight=1.008
                , relwidth=0.953)
        ...
        self.Frame_camera_type.place(relx=0.351, rely=0.092, relheight=0.574
                , relwidth=0.295)
        self.Frame_camera_type.configure(relief='groove')
        self.Frame_camera_type.configure(borderwidth="2")
        self.Frame_camera_type.configure(relief="groove")
        ...
        self.Listbox_camera_type.place(relx=0.0, rely=0.0, relheight=1.008
                , relwidth=0.958)
        ...
        self.Frame_camera_suffix.place(relx=0.658, rely=0.092, relheight=0.574
                , relwidth=0.297)
        self.Frame_camera_suffix.configure(relief='groove')
        self.Frame_camera_suffix.configure(borderwidth="2")
        self.Frame_camera_suffix.configure(relief="groove")
        ...
        self.Listboxcamer_suffix = tk.Listbox(self.Frame_camera_suffix)
        self.Listboxcamer_suffix.place(relx=0.0, rely=0.0, relheight=1.008
                , relwidth=0.953)
        self.Listboxcamer_suffix.configure(background="white")
        self.Listboxcamer_suffix.configure(disabledforeground="#a3a3a3")
        self.Listboxcamer_suffix.configure(exportselection="0")
        self.Listboxcamer_suffix.configure(font="TkFixedFont")
        self.Listboxcamer_suffix.configure(foreground="#000000")
        self.Listboxcamer_suffix.configure(highlightbackground="#d9d9d9")
        self.Listboxcamer_suffix.configure(highlightcolor="black")
        self.Listboxcamer_suffix.configure(selectbackground="#c4c4c4")
        self.Listboxcamer_suffix.configure(selectforeground="black")
        self.Listboxcamer_suffix.configure(selectmode='single')
        self.Listboxcamer_suffix_tooltip = \
        ToolTip(self.Listboxcamer_suffix, '''Camera File Suffix''')

        self.Entry_camera_name = tk.Entry(self.top)
        self.Entry_camera_name.place(relx=0.041, rely=0.029, height=40
                , relwidth=0.283)
        ...
        self.Entry_camera_type.place(relx=0.354, rely=0.029, height=40
                , relwidth=0.275)
        ...
        self.Entrycamera_suffix.place(relx=0.658, rely=0.029, height=40
                , relwidth=0.283)
