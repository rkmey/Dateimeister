...
class Toplevel_messages:
    def __init__(self, top=None):
        ...
        self.Frame_messages.place(relx=0.017, rely=0.014, relheight=0.896
                , relwidth=0.48)
        ...
        self.Frame_errors.place(relx=0.507, rely=0.014, relheight=0.9
                , relwidth=0.476)
        ...
        self.Text_errors.place(relx=0.0, rely=0.0, relheight=0.98, relwidth=0.98)
