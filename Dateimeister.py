...
class Toplevel_treeview_camera:
    def __init__(self, top=None):
        ...
        self.Entry_camera.place(relx=0.216, rely=0.906, height=30
                , relwidth=0.135)
        self.Entry_camera.configure(background="white")
        self.Entry_camera.configure(disabledforeground="#a3a3a3")
        self.Entry_camera.configure(font="TkFixedFont")
        ...
        self.Label_camera.place(relx=0.224, rely=0.956, height=20, width=174)
        ...
        self.Label_camera.configure(foreground="#000000")
