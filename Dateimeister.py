...
class Toplevel_treeview_camera:
    def __init__(self, top=None):
        ...
        self.Frame_treeview.place(relx=0.036, rely=0.084, relheight=0.727
                , relwidth=0.925)
        ...
        self.Scrolledtreeview_camera.place(relx=0.015, rely=0.099
                , relheight=0.787, relwidth=0.975)
        self.Scrolledtreeview_camera.configure(columns="Col1")
        # build_treeview_support starting.
        self.Scrolledtreeview_camera.heading("#0",text="Tree")
        self.Scrolledtreeview_camera.heading("#0",anchor="center")
        self.Scrolledtreeview_camera.column("#0",width="622")
        ...
        self.Scrolledtreeview_camera.heading("Col1",text="Col1")
        self.Scrolledtreeview_camera.heading("Col1",anchor="center")
        self.Scrolledtreeview_camera.column("Col1",width="622")
        ...
        self.Entry_new.place(relx=0.139, rely=0.909, height=30, relwidth=0.142)
        ...
        self.Label_new.place(relx=0.008, rely=0.909, height=31, width=165)
        ...
        self.Label_new.configure(text='''Label''')
        self.Button_apply = tk.Button(self.Frame_treeview)
        self.Button_apply.place(relx=0.293, rely=0.909, height=24, width=97)
