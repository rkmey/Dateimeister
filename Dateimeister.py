...
class Toplevel_messages:
    def __init__(self, top=None):
        ...
        self.Button_copy = tk.Button(self.top)
        self.Button_copy.place(relx=0.134, rely=0.919, height=34, width=87)
        self.Button_copy.configure(activebackground="beige")
        self.Button_copy.configure(activeforeground="black")
        self.Button_copy.configure(background="#d9d9d9")
        self.Button_copy.configure(compound='left')
        ...
        self.Button_copy_tooltip = \
        ToolTip(self.Button_copy, '''copy source to target''')

        self.Button4_delete = tk.Button(self.top)
        self.Button4_delete.place(relx=0.224, rely=0.919, height=34, width=77)
        self.Button4_delete.configure(activebackground="beige")
        self.Button4_delete.configure(activeforeground="black")
        self.Button4_delete.configure(background="#d9d9d9")
        self.Button4_delete.configure(compound='left')
        self.Button4_delete.configure(disabledforeground="#a3a3a3")
        self.Button4_delete.configure(foreground="#000000")
        self.Button4_delete.configure(highlightbackground="#d9d9d9")
        self.Button4_delete.configure(highlightcolor="black")
        self.Button4_delete.configure(pady="0")
        self.Button4_delete.configure(text='''delete''')
        self.Button4_delete_tooltip = \
        ToolTip(self.Button4_delete, '''delete copied files from target''')

        self.Checkbutton_delrelpath = tk.Checkbutton(self.top)
        self.Checkbutton_delrelpath.place(relx=0.298, rely=0.919, relheight=0.046
                , relwidth=0.123)
        self.Checkbutton_delrelpath.configure(activebackground="beige")
        self.Checkbutton_delrelpath.configure(activeforeground="black")
        self.Checkbutton_delrelpath.configure(anchor='w')
        ...
        self.Checkbutton_delrelpath.configure(variable=self.che49)
        self.Checkbutton_delrelpath_tooltip = \
        ...
        self.Radiobutton_deletescript.place(relx=0.015, rely=0.891
                , relheight=0.035, relwidth=0.042)
        ...
        self.Radiobutton_delrelpathscript.place(relx=0.015, rely=0.93
                , relheight=0.034, relwidth=0.042)
        ...
        self.Radiobutton_delrelpathscript.configure(text='''delrelpathscript''')
